                        ...
                        <tr>
                          <th class="small-12 large-12 columns first last">
                            <table>
                              <tr>
                                <th>
                                  <h1 class="text-center">Bienvenido al Sistema de Encuestas <?= $nombre_usuario ?></h1>
                                </th>
                            ...
                            <table>
                              <tr>
                                <th>
                                  ...
                                  <h4>Se ha Creado la Cuenta Exitosamente.</h4>
                                  <p>Datos de la Cuenta Registrada</p>
                                  <p>Email: <strong><?= $correo ?></strong></p>
                                  <p>Rol: <strong><?= $rol ?></strong></p>
                                  <p>Contraseña: <strong><?= $contrasena ?></strong></p>
                                  <br>
                                  <p>Recuerda que puedes Ingresar al Sistema en este boton.</p>
                                  <table class="button text-center">
                                    <tr>
                                      <td>
                                        <table>
                                          <tr>
                                            <td><a href="<?= base_url('login') ?>">Ingresar al Sitio</a></td>
                                          </tr>
                                        </table>
                                      </td>
                                    </tr>
