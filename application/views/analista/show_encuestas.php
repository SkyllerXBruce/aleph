...
<table class="table">
  ...
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col">Detalles de la Encuesta</th>
    </tr>
	</thead>
  ...
  <tbody>
    <?php foreach($data as $item): ?>
        ...
        <!-- Botones de Editar y Eliminar -->
      	<td><a class="btn btn-secondary" href="<?=base_url('analista/detalles/'.$item['idquest'])?>" role="button">Detalles de Encuesta</a></td>
    	</tr>
    <?php endforeach; ?>
  </tbody>
</table>